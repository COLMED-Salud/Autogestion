...
<div id="turnos">
    <table width="100%" style="font-family:'Arial', Gadget, sans-serif" cellpadding="4">
        <thead bgcolor="#000" style="font-size:28px" align="center">
            <td><font color="#FFFFFF"><b>TURNO </b></font></td>
            <td><font color="#FFFFFF"><b>PUESTO</b></font></td>
            <td><font color="#FFFFFF"><b>SECTOR</b></font></td>
        </thead>
    ...
    <?PHP include('fn/conexion.php');
         ...
         <tr style="font-size:70px" align="center">
			...
			<b><?PHP echo $ctrl["tipo"] . str_pad($ctrl["id"], 4, "0", STR_PAD_LEFT);?><br><font size="6"><?PHP echo $nomafil; ?></font></b>
            </td>
