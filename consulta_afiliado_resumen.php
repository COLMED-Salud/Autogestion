...
$result=mysql_query("SELECT * FROM fac_cabecera WHERE credencial = $_GET[user]");
...
<table class="tabla" border="0" align="center" width="100%" background="imagenes/fondo_bt.png">
	...
	<thead>
		<tr align="center">
			<th style="font-size:12px" align="center" bgcolor="#999999"><font color="#FFFFFF"><b>&nbsp;Factura Nro.&nbsp;</b></font></th>
			<th style="font-size:12px" align="center" bgcolor="#999999"><font color="#FFFFFF"><b>&nbsp;Periodo&nbsp;</b></font></th>
			<th style="font-size:12px" align="center" bgcolor="#999999"><font color="#FFFFFF"><b>&nbsp;Importe&nbsp;</b></font></th>
			<th style="font-size:12px" align="center" bgcolor="#999999"><font color="#FFFFFF"><b>&nbsp;Estado&nbsp;</b></font></th>
			<th style="font-size:12px" align="center" bgcolor="#999999"><font color="#FFFFFF"><b>&nbsp;Res&uacute;men&nbsp;</b></font></th> 
		</tr>
	</thead>
	...
	<tr>
		...
		<td style="font-size:10px" align="center">
		<input style="font-size:10px;width:100%" type ='buttond' value = 'Imprimir' 
         onClick="location.replace('imprimir_resumen.php?cpte=<?PHP echo $row["cpte_int"];?>&user=<?PHP echo $row["credencial"];?>&dni=<? echo $dni;?>');" class="button"/>
