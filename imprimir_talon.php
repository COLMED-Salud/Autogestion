        ...
        <tr>
            <td colspan="3" style="font-size:15px" align="center">
                <input style="font-size:25px;width:100%" type ='button' value = 'Volver'
             	 onClick="location.replace('consulta_afiliado_facturas.php?user=<? echo $credencial;?>&dni=<? echo $dni;?>');" class="button"/>
            </td>
        </tr>
...
<br>&nbsp;<br>&nbsp;<br>&nbsp;<br>&nbsp;<br>&nbsp;<br>&nbsp;<br>&nbsp;<br>&nbsp;<br>&nbsp;<br>&nbsp;<br>&nbsp;<br>&nbsp;<br>&nbsp;<br>&nbsp;<br>
	...
	<table width="270" border="0" cellspacing="2" cellpadding="2">
        <tr>
            <td colspan="3" align="center"><img src="imagenes/logo.png" alt="COLMED" width="150"/><hr></td>
        </tr>
        ...
        <tr>
            <td colspan="3" align="center" ><img src="<?PHP echo $img; ?>" alt="codigodebarras" width="100%"/><hr></td>
        </tr>
