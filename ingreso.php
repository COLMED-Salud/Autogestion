	...
	if($_POST['borrar'] == "Borrar"){
        ...
        <div align="center">
                <table>
                    ...
                    <tr>
                        <th colspan="3" align="center"><input maxlength="11" size="10%" type="text" name="dni" value="<?PHP echo $cadena; ?>" 
                        class="text" style="font-size:35px"  />
                        <br>&nbsp;<br>
                        </th>
                    </tr>
                    ...
                    <tr>
                    	<th colspan="3" align="center">
	                            <input style="font-size:28px;width:100%" type ='button' value = 'Volver'
             						onClick="location.replace('menu.php');" class="button"/>
                        </th>
                    </tr>
                    <tr>
