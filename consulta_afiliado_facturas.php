...
<table class="tabla" border="0" align="center" width="100%" background="imagenes/fondo_bt.png">
	...
	<thead>
		<tr align="center">
			<th style="font-size:10px" align="center" bgcolor="#999999"><font color="#FFFFFF"><b>&nbsp;Factura Nro.&nbsp;</b></font></th>
			<th style="font-size:10px" align="center" bgcolor="#999999"><font color="#FFFFFF"><b>&nbsp;Periodo&nbsp;</b></font></th>
			<th style="font-size:10px" align="center" bgcolor="#999999"><font color="#FFFFFF"><b>&nbsp;Vto.&nbsp;</b></font></th>
			<th style="font-size:10px" align="center" bgcolor="#999999"><font color="#FFFFFF"><b>&nbsp;Importe&nbsp;</b></font></th>
			<th style="font-size:10px" align="center" bgcolor="#999999"><font color="#FFFFFF"><b>&nbsp;Tal&oacute;n&nbsp;</b></font></th> 
		</tr>
	</thead>
	...
	<tr align="center">
		...
		<?PHP if($row["estado"]=="Pendiente"){
		      	if(!empty($row["cod_facil"])){?>
       		 	<input style="font-size:10px;width:80%" type ='buttond' value = 'Imprimir' 
                onClick="location.replace('imprimir_talon.php?cpte=<?PHP echo $row["cpte_int"];?>&user=<?PHP echo $row["credencial"];?>&dni=<? echo $dni;?>');" class="button"/>
				<?PHP }?>
