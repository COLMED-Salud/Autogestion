...
<body onload="imprimir();">
        ...
        <table width="100%" border="0" cellspacing="2" cellpadding="2">
            ...
            <tr>
                <td colspan="3" style="font-size:15px" align="center">
                    <input style="font-size:25px;width:100%" type='button' value='Volver' onClick="location.replace('consulta_afiliado_resumen.php?user=<? echo $credencial; ?>&dni=<? echo $dni; ?>');" class="button" />
                </td>
            </tr>

            <tr>
                <td colspan="3" style="font-size:15px" align="center">
                    <input style="font-size:25px;width:100%" type='button' value='Salir' onClick="location.replace('ingreso.php');" class="button" />
                </td>
            </tr>
    ...
    while ($datos = mysqli_fetch_array($result)) {
        ...
        <table width="250" border="0" cellspacing="2" cellpadding="2" align="center">
            ...
            <tr>
                <td colspan="3" align="center"><b>Resumen de Cuenta</b>
                    <hr>
                </td>
            </tr>
